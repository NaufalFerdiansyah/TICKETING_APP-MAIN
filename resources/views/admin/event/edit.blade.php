                ...
                <form id="eventForm" class="space-y-4" method="post"
                    ...
                    <div class="form-control">
                        ...
                        <input type="datetime-local" name="tanggal_waktu" class="input input-bordered w-full"
                            value="{{ $event->tanggal_waktu ? \Carbon\Carbon::parse($event->tanggal_waktu)->format('Y-m-d\TH:i') : '' }}"
                            required />
                    </div>
                    ...
                    <div class="form-control">
                        ...
                        <select name="location_id" class="select select-bordered w-full" required>
                            ...
                            <option value="{{ $location->id }}" {{ $event->location_id == $location->id ? 'selected' : '' }}>
                                {{ $location->nama }} - {{ $location->kota }} (Kapasitas: {{ number_format($location->kapasitas) }})
                            </option>
                            @endforeach
                        </select>
                    </div>

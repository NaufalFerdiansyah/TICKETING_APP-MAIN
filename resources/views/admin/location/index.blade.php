<x-layouts.admin title="Manajemen Lokasi">
    ...
    <div class="container mx-auto px-6 py-8">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">Kelola lokasi event Anda</p>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-orange-50 to-white px-6 py-4 border-b border-gray-100">
                ...
                <p class="text-sm text-gray-500 mt-1">Total: {{ count($locations) }} lokasi</p>
            </div>
                ...
                <table class="table w-full">
                    ...
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="text-gray-600 font-semibold">Alamat</th>
                    ...
                    <tbody>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="text-gray-600">{{ $location->alamat }}</td>
                            ...
                            <td>
                                <div class="flex justify-center space-x-2">
                                    <button
                                        ...
                                        data-kota="{{ $location->kota }}"
                                        data-kapasitas="{{ $location->kapasitas }}">
                        ...
                        <tr>
                            <td colspan="6" class="text-center py-12">
                                <div class="flex flex-col items-center justify-center text-gray-400">
                                    ...
                                    <p class="text-sm mt-1">Klik tombol "Tambah Lokasi" untuk membuat lokasi baru
                                    </p>
                                </div>
                            </td>
                        </tr>
        ...
        <div class="modal-box max-w-lg rounded-2xl">
            <form method="POST" action="{{ route('admin.locations.store') }}">
                ...
                <div class="flex items-center space-x-3 mb-6">
                    ...
                    <h3 class="text-xl font-bold text-gray-800">Tambah Lokasi</h3>
                </div>

                <div class="form-control w-full mb-4">
                    <label class="label">
                        <span class="label-text font-medium text-gray-700">Nama Lokasi</span>
                    </label>
                    <input type="text" placeholder="Contoh: Stadion Utama"
                        class="input input-bordered w-full focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all"
                        name="nama" required />
                </div>

                <div class="form-control w-full mb-4">
                    <label class="label">
                        <span class="label-text font-medium text-gray-700">Alamat</span>
                    </label>
                    <textarea placeholder="Masukkan alamat lengkap"
                        class="textarea textarea-bordered w-full focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all"
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                    <div class="form-control w-full">
                        <label class="label">
                            <span class="label-text font-medium text-gray-700">Kota</span>
                        </label>
                    ...
                    <div class="form-control w-full">
                        <label class="label">
                            <span class="label-text font-medium text-gray-700">Kapasitas</span>
                        </label>
                        <input type="number" placeholder="Contoh: 5000"
                            class="input input-bordered w-full focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all"
                            name="kapasitas" min="1" required />
                    </div>
                </div>

                <div class="modal-action">
                    <button
                        class="btn bg-gradient-to-r from-orange-500 to-orange-600 text-white border-0 hover:from-orange-600 hover:to-orange-700"
                        type="submit">
                        Simpan
                    </button>
        ...
        <div class="modal-box max-w-lg rounded-2xl">
            <form method="POST">
                ...
                <div class="flex items-center space-x-3 mb-6">
                    ...
                    <h3 class="text-xl font-bold text-gray-800">Edit Lokasi</h3>
                </div>
                ...
                <div class="form-control w-full mb-4">
                    ...
                    <textarea placeholder="Masukkan alamat lengkap"
                        ...
                        id="edit_location_address" name="alamat" rows="3" required></textarea>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                    <div class="form-control w-full">
                        ...
                        <input type="text" placeholder="Masukkan kota"
                            class="input input-bordered w-full focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all"
                            id="edit_location_city" name="kota" required />
                    </div>
                    ...
                    <div class="form-control w-full">
                        ...
                        <input type="number" placeholder="Masukkan kapasitas"
                            class="input input-bordered w-full focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all"
                            id="edit_location_capacity" name="kapasitas" min="1" required />
                    </div>
                </div>
    ...
    function openEditModal(button) {
        ...
        const address = button.dataset.alamat;
        const city = button.dataset.kota;
        const capacity = button.dataset.kapasitas;
        ...
        document.getElementById("edit_location_capacity").value = capacity;
